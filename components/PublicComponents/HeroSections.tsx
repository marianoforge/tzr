...
const HeroSection = () => {
  return (
    <section className="text-white relative flex flex-col text-center sm:text-center md:text-start gap-8 md:flex-row w-full pb-24 pt-16 sm:pb-32 sm:pt-24 md:pb-48 md:pt-20 items-center justify-center">
