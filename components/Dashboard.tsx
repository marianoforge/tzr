  ...
  return (
    <>
      <div className="flex flex-row justify-between items-center">
        <div className="text-[28px] font-bold hidden h-[64px] lg:flex md:flex-col justify-center pl-4 w-1/2">
          Dashboard Principal
        </div>
        <div className="hidden lg:flex flex-row justify-end items-center gap-2 w-1/2">
          <UserAvatar />
